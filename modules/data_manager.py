...
def registrar_ubicacion():
    ...
    while True:
        ...
        try:
            ...
            print("\nRegistro cancelado por dato ingresado")
            precionar_continuar()
            continue
...
def pagar_cuota_credito():
    ...
    while salir == 's':
        ...
        if cuentas_bancarias[cuenta_ingresada]["saldo"] <= 0:
            ...
            print('Actual mente tu cuenta esta regitrada como: ',cuentas_bancarias[cuenta_ingresada]["tipo"])
        ...
        try:
            ...
            match opcion:
                case '1':
                    ...
                    archivo_json(file_path, initial_structure = {})
                    precionar_continuar()
                case '2':
                    solicitar_credito()
                case '3':
